    ...
    <Container sx={{ mt: 4 }}>
        ...
        <Grid item xs={12} md={3}>
          <Card>
            <CardContent sx={{ textAlign: 'center' }}>
              ...
              <Typography variant="h4">{pending_profiles_count}</Typography>
              <Typography color="textSecondary">Pending Profiles</Typography>
            </CardContent>
          </Card>
        </Grid>
      </Grid>
      ...
      <Box mb={3}>
        ...
        <Button
          variant="contained"
          color="warning"
          onClick={() => navigate('/employees/pending-profiles')}
          sx={{ mr: 2 }}
        >
          Pending Profiles ({pending_profiles_count})
        </Button>
        <Button
          variant="contained"
          color="info"
